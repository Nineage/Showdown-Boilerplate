...
var commands = exports.commands = {
	...
	bd: function(target, room, user) {
                    ...
                    this.sendReplyBox('<center><img src="http://i.snag.gy/ganNp.jpg"><br />' +
									...
									' People who have purchased this: koikazma, Black Rabbit, hashtag armcannons, nonstopkevn, DavidJ, Félicette, jd, retrofeather, Absolute Maximum, Feeboss, Giantsdms, xVeNoMiiZz, KafkaBlack, Quilavaa, Chakra, Connor the Goodra, and of course: Da Bic Boi. </center>'
                                      )
            },
